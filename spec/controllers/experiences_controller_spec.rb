...
describe ExperiencesController do
  ...
  let(:experience) { create :experience, user: user, experienceable: knowledge }

  def valid_attributes
    {title: 'ruby',
    content: 'ruby',
    user_id: user.id,
    experienceable_type: knowledge.class.name,
    experienceable_id: knowledge.id}
  end
  ...
  describe "authenticated" do
    ...
    describe "GET new" do
      it "assigns a new experience as @experience" do
        get :new, {experienceable_type: knowledge.class.name, experienceable_id: knowledge.id}
